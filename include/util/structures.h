...
const float SIZE_X_CM = 235;//2,9 en casa
const float SIZE_Y_CM = 174;//2,15 en casa

const int ALT_CAMERA = 3000;//3000 //en cm //3700cm en casa
...
struct Copter
{
	/*theta  pitch in milli-degrees
	  ...
	  psi    yaw   in milli-degrees */
		...
		float     altitude;               /*!< UAV's altitude in centimeters */
