...
class UI
{
	...
	public:
		...
		static void drawDestinations(cv::Mat &image, std::vector<cv::Point2i > destinations);
		...
		static void drawNextDestination(cv::Mat &image, std::vector<cv::Point2i > destinations, int destination);
